...
import com.dotozambo.StockBotApplication;
...
public class LineMessageController 
{
    ...
    public void handleImageMessageEvent(MessageEvent<ImageMessageContent> event) throws IOException {
        ...
        handleHeavyContent(
                ...
                responseBody -> {
                    ...
                    reply(((MessageEvent<ImageMessageContent>) event).getReplyToken(),
        ...
        handleHeavyContent(
                ...
                responseBody -> {
                    ...
                    system("convert",
                           mp4.path + "[0]",
                           previewImg.path.toString());
                    reply(((MessageEvent<VideoMessageContent>) event).getReplyToken(),
    ...
    private static DownloadedContent createTempFile(String ext) {
        ...
        Path tempFile = StockBotApplication.downloadedContentDir.resolve(fileName);
